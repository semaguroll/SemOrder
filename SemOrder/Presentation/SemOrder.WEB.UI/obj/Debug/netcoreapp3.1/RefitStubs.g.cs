...
namespace SemOrder.WEB.UI.APIs
{
    ...
    partial class AutoGeneratedIUserApi : IUserApi
    {
        ...
        /// <inheritdoc />
        Task<ActionResult<WebApiResponse<List<UserResponse>>>> IUserApi.List()
        {
            var arguments = new object[] {  };
            var func = requestBuilder.BuildRestResultFuncForMethod("List", new Type[] {  });
            return (Task<ActionResult<WebApiResponse<List<UserResponse>>>>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<ActionResult<WebApiResponse<UserResponse>>> IUserApi.Get(Guid id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(Guid) });
            return (Task<ActionResult<WebApiResponse<UserResponse>>>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<ActionResult<WebApiResponse<UserResponse>>> IUserApi.Add(UserRequest request)
        {
            var arguments = new object[] { request };
            var func = requestBuilder.BuildRestResultFuncForMethod("Add", new Type[] { typeof(UserRequest) });
            return (Task<ActionResult<WebApiResponse<UserResponse>>>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<ActionResult<WebApiResponse<UserResponse>>> IUserApi.Update(Guid id, UserRequest request)
        {
            var arguments = new object[] { id, request };
            var func = requestBuilder.BuildRestResultFuncForMethod("Update", new Type[] { typeof(Guid), typeof(UserRequest) });
            return (Task<ActionResult<WebApiResponse<UserResponse>>>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<ActionResult<WebApiResponse<bool>>> IUserApi.Delete(Guid id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("Delete", new Type[] { typeof(Guid) });
            return (Task<ActionResult<WebApiResponse<bool>>>)func(Client, arguments);
        ...
        /// <inheritdoc />
        Task<ActionResult<WebApiResponse<List<UserResponse>>>> IUserApi.GetActive()
        {
            var arguments = new object[] {  };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetActive", new Type[] {  });
            return (Task<ActionResult<WebApiResponse<List<UserResponse>>>>)func(Client, arguments);
        ...
        /// <inheritdoc />
        Task<ActionResult<WebApiResponse<bool>>> IUserApi.Activate(Guid id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("Activate", new Type[] { typeof(Guid) });
            return (Task<ActionResult<WebApiResponse<bool>>>)func(Client, arguments);
        ...
        /// <inheritdoc />
        Task<ActionResult<WebApiResponse<bool>>> IUserApi.Inactivate(Guid id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("Inactivate", new Type[] { typeof(Guid) });
            return (Task<ActionResult<WebApiResponse<bool>>>)func(Client, arguments);
